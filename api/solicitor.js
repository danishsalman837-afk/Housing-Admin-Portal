              ...
              <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td align="center" style="background-color: #0A84FF; width: 48px; height: 48px; border-radius: 14px;">
                    <span style="color: #ffffff; font-size: 20px; font-weight: 800; font-family: Arial, sans-serif; line-height: 48px;">H</span>
                  </td>
                </tr>
              </table>
              <h1 style="margin: 16px 0 0; font-size: 22px; font-weight: 700; color: #1C1C1E; letter-spacing: -0.5px; font-family: Arial, sans-serif;">Housing Disrepair Lead</h1>
